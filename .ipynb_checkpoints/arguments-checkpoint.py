...
def parse_args():
    ...
    parser.add_argument('--n_iter', type=int, default=70000, help='number of meta-iterations')
    parser.add_argument('--n', type=int, default=1, help='number of meta-iterations')
    ...
    parser.add_argument('--lr_inner', type=float, default=0.01, help='inner-loop learning rate (task-specific)')
    ...
    parser.add_argument('--num_context_params', type=int, default=0, help='number of context parameters (added at first layer)')
    ...
    parser.add_argument('--test', action='store_true', default=False, help='run MAML')
...
def parse_args_psro():
    ...
    parser.add_argument('--maml_bs', type=int, default=25)
    parser.add_argument('--par_bs', type=int, default=4)
    ...
    parser.add_argument('--lr_inner', type=float, default=0.01, help='inner-loop learning rate (task-specific)')
    parser.add_argument('--lr_meta', type=float, default=0.001, help='outer-loop learning rate')
    parser.add_argument('--lr_par', type=float, default=0.1, help='outer-loop learning rate')
    ...
    parser.add_argument('--psro_iters', type=int, default=300)
    parser.add_argument('--maml_train_iter', type=int, default=100)
    parser.add_argument('--par_train_iter', type=int, default=5)
