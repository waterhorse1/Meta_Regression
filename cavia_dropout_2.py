...
def run(args, log_interval=5000, rerun=False):
    ...
    for i_iter in range(args.n_iter):
        ...
        for t in range(args.tasks_per_metaupdate):
            ...
            l_optimizer = [optim.SGD(copy_model.fc_layers[0].parameters(), args.lr_inner),\
                   optim.SGD(copy_model.fc_layers[1].parameters(), args.lr_inner),\
                   optim.SGD(copy_model.fc_layers[2].parameters(), args.lr_inner)]
            ...
            for _ in range(args.num_inner_updates):
                ...
                train_outputs = copy_model(train_inputs)
