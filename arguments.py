...
def parse_args():
    ...
    parser.add_argument('--lr_L', type=float, default=0.001, help='outer-loop learning rate')
    ...
    parser.add_argument('--num_context_params', type=int, default=[5,5,5], help='number of context parameters (added at first layer)')
